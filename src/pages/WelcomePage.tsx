        ...
        <div className="p-6 md:p-8 space-y-8">
          <div>
            ...
            <p className="text-white/60 leading-relaxed max-w-2xl">
              La extensión está activa y lista. Cuando visites cualquier
              formulario, detectará automáticamente los campos y te sugerirá las
              respuestas en base a tu perfil local configurado en la extensión,
              manteniendo completa privacidad y fricción casi nula.
            </p>
          </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mt-6">
        <div className="bg-surface/90 border border-white/10 rounded-xl p-6 hover:border-white/20 transition-colors">
          ...
          <p className="text-ghost text-[12px] leading-relaxed">
            Próximamente: Métricas sobre la cantidad de caracteres ahorrados y
        ...
        <div className="bg-surface/90 border border-white/10 rounded-xl p-6 hover:border-brand-primary/30 transition-colors group">
          ...
          <p className="text-ghost text-[12px] leading-relaxed">
            Funciones avanzadas: múltiples alias comerciales y AI-Gen Cover
            Letters en un click.
          </p>
        </div>
      </div>

...
export const OnboardingGuide: FC = () => {
  ...
  const aiCapacity = Math.min(
    100,
    Math.round(
      baseCapacity + (completedSteps / totalSteps) * (100 - baseCapacity),
    ),
  );
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-6 mb-8">
          <div className="flex-1">
            ...
            <p className="text-ghost text-sm leading-relaxed max-w-xl">
              Completa estos pasos para que Cognilot pueda autocompletar
              cualquier formulario con precisión milimétrica.
            </p>
          </div>
